  ...
  public: {
    Tables: {
      ...
      group_invitations: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "group_invitations_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
      ...
      sessions: {
        Row: {
          ...
          location_display_address: string | null
      ...
      user_dupr_connections: {
        Row: {
          access_token: string | null
          created_at: string | null
          dupr_email: string | null
          dupr_user_id: string | null
    ...
    Functions: {
      ...
      create_session_conversation: {
        Args: { session_id: string; session_name: string }
        Returns: string
      }
